...
// var header = document.getElementById("activesb");
// var btns = header.getElementById("btn");
...
const activesb = window.location.pathname;
  const navLink = document.querySelectorAll('sidebar').forEach(link => {
    if (link.href.includes(`${btn}`)) {
    link.classList.add('active');
    }
})